...
/** Shared header + footer for secondary marketing pages (practice areas, solutions). */
      ...
      <header className="sticky top-0 z-50 bg-praxium-bg/85 backdrop-blur-xl border-b border-praxium-line">
        <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-1">
            <Link to="/practice-areas" className="px-3 py-1.5 text-xs font-mono uppercase tracking-[0.15em] text-praxium-subtle hover:text-praxium-ink transition-colors">Practice areas</Link>
