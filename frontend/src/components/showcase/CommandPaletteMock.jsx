  ...
  return (
    <div className="bg-praxium-ink rounded-sm shadow-2xl overflow-hidden border border-white/10">
      ...
      <div className="flex items-center gap-2 px-4 py-3 border-b border-white/10">
        ...
        <div className="flex-1 text-center text-[10px] font-mono text-white/30">
          ⌘ K · command palette
        </div>
      </div>
      ...
      <div className="max-h-[440px] py-2">
        {GROUPS.map((g) => (
          <div key={g.label} className="px-2">
            <div className="px-3 py-1.5 text-[10px] font-mono uppercase tracking-[0.2em] text-white/30">
              // {g.label.toLowerCase()}
            </div>
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div
                      className={`text-[11px] font-mono mt-0.5 truncate ${
                        it.active ? "text-white/70" : "text-white/40"
                      }`}
                    >
                      {it.sub}
                    </div>
      ...
      {/* Footer */}
      <div className="px-5 py-2.5 border-t border-white/10 flex items-center justify-between text-[10px] font-mono text-white/40">
