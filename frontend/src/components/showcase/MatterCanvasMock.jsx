      ...
      >
        <div className="flex">
          ...
          <aside className="hidden md:flex flex-col w-12 bg-praxium-ink border-r border-white/5 py-4 gap-3 items-center">
            <div className="w-7 h-7 bg-praxium-accent-hover flex items-center justify-center font-display font-black text-white text-sm">
              π
            </div>
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="px-6 py-4 border-b border-praxium-line flex items-start justify-between gap-4 flex-wrap">
              ...
              <div className="flex items-center gap-3">
                <AvatarGroup
                  users={[
                    { initials: "SJ", color: "#DC2F02" },
                    { initials: "DP", color: "#121212" },
                    { initials: "MR", color: "#5E6C5A" },
                  ]}
                  size={26}
                />
            ...
            <div className="px-6 flex items-center gap-0.5 border-b border-praxium-line overflow-x-auto">
              {TABS.map((t) => (
                ...
                >
                  {t.label}
                  {t.count != null && (
                    <span className="ml-1.5 text-praxium-subtle tabular">
                      {t.count}
                    </span>
                  )}
                </div>
            ...
            <div className="grid grid-cols-12 gap-px bg-praxium-line">
              ...
              <div className="col-span-12 lg:col-span-5 bg-praxium-surface p-5">
                    ...
                    <div key={i} className="flex items-start gap-3">
                      ...
                      <div className="flex-1 min-w-0 text-sm">
                        <div className="flex items-center gap-2 flex-wrap">
                          ...
                          <span className="text-praxium-subtle text-xs">
                            {a.text}
                          </span>
                        </div>
                ...
                <div className="mt-5 pt-3 border-t border-praxium-line text-[10px] font-mono uppercase tracking-[0.15em] text-praxium-accent-text">
                  View full timeline →
                </div>
              </div>
              ...
              <div className="col-span-12 lg:col-span-3 bg-praxium-ink text-white p-5">
                ...
                <div className="mt-5 pt-4 border-t border-white/10 text-[10px] font-mono text-white/60 leading-relaxed">
