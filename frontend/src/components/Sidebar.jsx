...
const NAV = [
  ...
  { to: "/praxa-matches", label: "Praxa Ops", icon: Heart, testid: "nav-praxa-matches" },
  ...
  { to: "/mailbox", label: "Intake Mailbox", icon: Mailbox, testid: "nav-mailbox" },
  { to: "/trust", label: "Trust Recon", icon: Landmark, testid: "nav-trust" },
];
