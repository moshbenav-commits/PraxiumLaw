# PraxiumLaw Knowledge Articles

Recommended, **white-label** standard-operating procedures for personal-injury and related practice, organized by department. Written for **any firm** and aimed especially at **smaller/newer firms** building their operations.

## Disclosure (applies to every article)

These articles are **recommended procedures and operational education, not legal advice, and not your firm's rules.** Before using any script, checklist, or process in a live matter:

1. **Cross-reference** each procedure against your firm's own policies and your jurisdiction's law and ethics rules.
2. Have a **licensed attorney** review and approve.
3. Edit all related documents (letters, forms, fee agreements) — do not use templates as-is.

Full text: [`../DISCLOSURE.md`](../DISCLOSURE.md) · White-label rules: [`../WHITE_LABEL.md`](../WHITE_LABEL.md) · Public sources: [`../REFERENCES.md`](../REFERENCES.md)

## Start here

**▶ [00 — Case lifecycle & workflow map](00-case-lifecycle-and-workflow-map.md)** — the end-to-end path for running a full case, with the gate and article for every phase.

## Index by department

### Intake & sign-up
- [01 — Intake needs list](01-intake-needs-list.md)
- [13 — Conflict check & related cases](13-conflict-check-and-related-cases.md)
- [14 — Client insurance script](14-client-insurance-script.md)
...
- [05 — Treatment gaps & MRI timing](05-treatment-gaps-and-mri-timing.md)
- [08 — Meds tab & record hygiene](08-meds-tab-and-record-hygiene.md)
- [12 — Chiro follow-up color codes](12-chiro-follow-up-color-codes.md)
...
- [07 — Thirty-day case review](07-thirty-day-case-review.md)
- [11 — Client call cadence](11-client-call-cadence.md)
- [18 — Document taxonomy](18-document-taxonomy.md)
- [19 — Redaction checklist](19-redaction-checklist.md)
- [20 — Certificate of records](20-certificate-of-records.md)
- [34 — Correspondence & communications standards](34-correspondence-and-communications.md)

### Demand, settlement & disbursement
- [09 — Demand prep checklist](09-demand-prep-checklist.md)
- [39 — Demand letter drafting](39-demand-letter-drafting.md)
- [10 — Settlement calculator scenarios](10-settlement-calculator-scenarios.md)
- [25 — Disbursement sheet preparation](25-disbursement-sheet-preparation.md)
- [26 — Reduction requests & provider negotiation](26-reduction-requests-and-negotiation.md)
...
- [31 — Litigation handoff & case management](31-litigation-handoff-and-management.md)
- [30 — Minor's compromise & court approval](30-minors-compromise-and-court-approval.md)
- [32 — Mass tort intake & management](32-mass-tort-intake-and-management.md)
- [41 — Premises liability & slip-and-fall](41-premises-liability-slip-and-fall.md)
- [42 — Workers' compensation coordination](42-workers-compensation-coordination.md)
- [43 — MIST (minor impact, soft-tissue) strategy](43-mist-minor-impact-soft-tissue.md)

### Lifecycle exits & firm operations
- [28 — Client termination & attorney liens](28-client-termination-and-attorney-liens.md)
- [36 — Case management system setup](36-case-management-system-setup.md)
